...
public class ChristmasHatModel extends GeoModel<ChristmasHatModel.ChristmasHatAnimatable> {
    ...
    private static final ResourceLocation MODEL =
        ResourceLocation.fromNamespaceAndPath(Evilseagull.MODID, "geo/christmas_hat.geo.json");
    private static final ResourceLocation TEXTURE =
        ResourceLocation.fromNamespaceAndPath(Evilseagull.MODID, "textures/entity/christmas_hat.png");
